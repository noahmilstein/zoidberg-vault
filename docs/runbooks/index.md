...
## Active SOPs / Runbooks
- `self-audit-sop.md` — weekly markdown hygiene + architecture drift checks
- `zoidberg-outbound-classification.md` — outbound classification policy
